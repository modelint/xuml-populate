...
[`xuml-metamodel`](https://pypi.org/project/xuml-metamodel/) package, which `modeldb` depends on — so you do
...
that `modeldb` populates — so there is nothing extra to download or place in your working directory.
