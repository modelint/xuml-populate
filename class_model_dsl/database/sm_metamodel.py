"""
sm_metamodel.py -- SM Metamodel DB relational variable definitions
...
class SM_Metamodel():
    """
    The Shlaer-Mellor Metamodel relvars and constraints which constitutes the db schema
    This data is used to build a database
    """
...
def define(db) -> dict:
    ...
    return {
        ...
        'Super Identifier': Table('Super Identifier', db.MetaData,
                                  Column('Number', Integer, nullable=False, primary_key=True),
                                  Column('Class', Text, nullable=False, primary_key=True),
                                  Column('Domain', Text, nullable=False, primary_key=True),
                                  PrimaryKeyConstraint('Number', 'Class', 'Domain', name='I'),
        ...
        'Ordinal Relationship': Table('Ordinal Relationship', db.MetaData,
                                      Column('Rnum', Text, nullable=False, primary_key=True),
                                      Column('Domain', Text, nullable=False, primary_key=True),
                                      Column('Ranked class', Text, nullable=False, primary_key=False),
                                      Column('Ranking attribute', Text, nullable=False, primary_key=False),
                                      Column('Ranking identifier', Text, nullable=False, primary_key=False),
                                      Column('Ascending perspective', Text, nullable=False, primary_key=False),
                                      Column('Descending perspective', Text, nullable=False, primary_key=False),
                                      PrimaryKeyConstraint('Rnum', 'Domain', name='I'),
                                      ForeignKeyConstraint(('Rnum', 'Domain',),
                                                           ['Relationship.Rnum', 'Relationship.Domain'],
                                                           name='R100'),
                                      ForeignKeyConstraint(('Ranked class', 'Domain',),
                                                           ['Class.Name', 'Class.Domain'], name='R104'),
                                      ForeignKeyConstraint(('Ranking identifier', 'Ranked class', 'Domain',),
                                                           ['Identifier.Number', 'Identifier.Class',
                                                            'Identifier.Domain'],
                                                           name='R107'),
                                      ForeignKeyConstraint(
                                          ('Ranking attribute', 'Ranking identifier', 'Ranked class', 'Domain',),
                                          ['Identifier Attribute.Attribute', 'Identifier Attribute.Identifier',
                                           'Identifier Attribute.Class', 'Identifier Attribute.Domain'], name='R106'),
                                      ),
        ...
        'Perspective': Table('Perspective', db.MetaData,
                             ...
                             UniqueConstraint('Rnum', 'Domain', 'Phrase', name='I2'),
        ...
        'T Perspective': Table('T Perspective', db.MetaData,
                               Column('Side', Text, nullable=False, primary_key=False),
                               Column('Rnum', Text, nullable=False, primary_key=True),
                               Column('Domain', Text, nullable=False, primary_key=True),
                               PrimaryKeyConstraint('Rnum', 'Domain', name='I'),
                               ForeignKeyConstraint(('Side', 'Rnum', 'Domain',),
                                                    ['Asymmetric Perspective.Side', 'Asymmetric Perspective.Rnum',
        ...
        'T Reference': Table('T Reference', db.MetaData,
                             ...
                             ForeignKeyConstraint(
                                 ...
                                 ['Association Class Reference.Ref type',
