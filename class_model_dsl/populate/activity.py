...
from class_model_dsl.test.scrall.iassign.scrall_parser import ScrallParser
...
class Activity:
    ...
    def parse(cls, actions, debug=False):
        # Read the test file
        test_file_dir = Path(__file__).parent.parent / "test" / "scrall" / "iassign"
        test_file_path = test_file_dir / "iassign.scrall"
