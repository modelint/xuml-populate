        ...
        match type(sexpr).__name__:
            case 'INST_PROJ_a':
                ...
                initial_aid, final_aid, component_flow = InstanceSet.process(mmdb=cls.mmdb,
                                                                             input_instance_flow=action_input,
                ...
                action_input = component_flow
                aid, sflows = ReadAction.populate(cls.mmdb, input_single_instance_flow=action_input,
            ...
            case 'MATH_a':
                ...
                for o in sexpr.operands:
                    match type(o).__name__:
                        case 'INST_PROJ_a':
                            component_flow = InstanceSet.process(mmdb=cls.mmdb, input_instance_flow=action_input,
