...
class TableExpr:
    ...
    @classmethod
    def process(cls, tuple_output: bool, activity: 'Activity', rhs: TEXPR_a, input_instance_flow: Flow_ap
    ...
    def walk(cls, texpr: TEXPR_a, input_nsflow: Flow_ap) -> Flow_ap:
        ...
        match type(texpr.table).__name__:
            ...
            case 'INST_a':
                ...
                iset = InstanceSet(input_instance_flow=input_flow, iset_components=texpr.table.components,
        ...
        if texpr.projection:
            ...
            aid, component_flow = ProjectAction.populate(input_nsflow=input_flow,
                                                         projection=texpr.projection, activity=cls.activity)
            cls.action_inputs[aid] = {input_flow.fid}
            cls.action_outputs[aid] = {component_flow.fid}
