...
Cancel_Delayed_Signal_Action_i = namedtuple('Cancel_Delayed_Signal_Action_i', 'ID Activity Domain')
Cancel_Delayed_Completion_Signal_i = namedtuple('Cancel_Delayed_Completion_Signal_i', 'ID Activity Domain')
Cancel_Delayed_Interaction_Signal_i = namedtuple('Cancel_Delayed_Interaction_Signal_i', 'ID Activity Domain')
...
Interaction_Signal_Action_i = namedtuple('Interaction_Signal_Action_i', 'ID Activity Domain Instance_flow')
...
Signal_Instance_Action_i = namedtuple('Signal_Instance_Action_i', 'ID Activity Domain')
Signal_Instance_Set_Action_i = namedtuple('Signal_Instance_Set_Action_i', 'ID Activity Domain')
