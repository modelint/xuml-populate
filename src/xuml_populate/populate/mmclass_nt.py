...
Boolean_Partition_i = namedtuple('Boolean_Partition_i', 'ID Activity Domain True_flow False_flow')
Computation_Action_i = namedtuple('Computation_Action_i', 'ID Activity Domain Expression')
Computation_Input_i = namedtuple('Computation_Input_i', 'Computation Activity Domain Input_flow')
General_Computation_i = namedtuple('General_Computation_i', 'ID Activity Domain Result_flow')
...
External_Signal_Action_i = namedtuple('External_Signal_Action_i', 'ID Activity Domain External_event EE')
External_Signal_Parameter_i = namedtuple('External_Signal_Parameter_i', 'Signal_action Activity EE Domain Parameter Signature Flow')
Operation_Call_i = namedtuple('Operation_Call_i', 'ID Activity Domain Operation EE')
Operation_Call_Output_i = namedtuple('Operation_Call_Output_i', 'Operation_call Activity EE Domain Operation_name Flow')
Operation_Call_Parameter_i = namedtuple('Operation_Call_Parameter_i', 'Operation_call Activity Parameter Signature EE Domain Flow')
Service_Response_i = namedtuple('Service_Response_i', 'External_event Response_event State_model EE Domain')
...
Flow_Connector_i = namedtuple('Flow_Connector_i', 'ID Activity Domain')
...
Cast_To_Instance_i = namedtuple('Cast_To_Instance_i', 'ID Activity Domain Instance_flow Relation_flow')
...
Scalar_Value_i = namedtuple('Scalar_Value_i', 'Flow Activity Domain Name')
...
Creation_Signature_i = namedtuple('Creation_Signature_i', 'SIGnum Domain')
Delegated_Creation_Activity_i = namedtuple('Delegated_Creation_Activity_i', 'Anum Domain Signature')
...
Default_Initialization_i = namedtuple('Default_Initialization_i', 'Create_action Activity Attribute Class Domain Initial_value_specified')
Delegated_Create_Action_i = namedtuple('Delegated_Create_Action_i', 'ID Activity Domain')
Delete_Action_i = namedtuple('Delete_Action_i', 'ID Activity Domain Flow')
...
Initial_Pseudo_State_i = namedtuple('Initial_Pseudo_State_i', 'Name Class Domain Creation_activity')
...
Cancel_Delayed_Signal_Action_i = namedtuple('Cancel_Delayed_Signal_Action_i', 'ID Activity Domain Instance_flow')
Delivery_Time_i = namedtuple('Delivery_Time_i', 'Action Activity Domain Flow Relative')
Initial_Signal_Action_i = namedtuple('Initial_Signal_Action_i', 'ID Activity Domain Class Pseudo_state')
...
Signal_Action_i = namedtuple('Signal_Action_i', 'ID Activity Domain')
Signal_Assigner_Action_i = namedtuple('Signal_Assigner_Action_i', 'ID Activity Domain Association')
Send_Signal_Action_i = namedtuple('Send_Signal_Action_i', 'ID Activity Domain Event_spec State_model')
Signal_Completion_Action_i = namedtuple('Signal_Completion_Action_i', 'ID Activity Domain')
Signal_Instance_Action_i = namedtuple('Signal_Instance_Action_i', 'ID Activity Domain Instance_flow')
