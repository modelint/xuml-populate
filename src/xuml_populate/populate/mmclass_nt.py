...
Comparison_Criterion_i = namedtuple('Comparison_Criterion_i', 'ID Action Activity Attribute Table Domain Value Comparison')
Equivalence_Criterion_i = namedtuple('Equivalence_Criterion_i', 'ID Action Activity Attribute Table Domain Operation Value Scalar')
...
Ranking_Criterion_i = namedtuple('Ranking_Criterion_i', 'ID Action Activity Attribute Table Domain Order')
